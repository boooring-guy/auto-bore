...
export const PlaceholderNode = forwardRef<HTMLDivElement, PlaceholderNodeProps>(
  ({ children, onClick }, ref) => {
    ...
    return (
      <BaseNode
        ref={ref}
        className="size-auto cursor-pointer border-dashed border-gray-400 bg-card p-4 text-center text-gray-400 shadow-none  hover:bg-accent hover:ring-primary/50 hover:ring-1 transition-all duration-100"
        onClick={onClick}
      >
        {children}
        <Handle
