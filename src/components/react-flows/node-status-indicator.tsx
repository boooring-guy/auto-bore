  ...
  return (
    <>
      ...
      `}
        ...
        >
          <div className="spinner rounded-full bg-conic-0 from-primary to-primary/0 " />
        </div>
      </div>
      {children}
    </>
...
export const NodeStatusIndicator = ({
  ...
  switch (status) {
    ...
    case "success":
      return (
        <StatusBorder className={cn("border-emerald-700", className)}>
          {children}
        </StatusBorder>
      )
    case "error":
      return (
        <StatusBorder className={cn("border-rose-500 ", className)}>
          {children}
        </StatusBorder>
      )
    default:
